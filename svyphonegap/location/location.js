angular.module('svyphonegapLocation', ['servoy']).factory("svyphonegapLocation", function($services) {
		...
		return {
			...
			/**
			 * Returns the device's current position to the geolocationSuccess callback with a <br>Position object as the parameter. If there is an error, the geolocationError <br>callback is passed a PositionError object. <br>Possible options are<br><ul>
